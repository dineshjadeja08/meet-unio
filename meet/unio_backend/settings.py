"""
Django settings for unio_backend project.
"""
...
INSTALLED_APPS = [
    # 'daphne',  # Uncomment for WebSocket support with Daphne ASGI server
...
ASGI_APPLICATION = 'unio_backend.asgi.application'
...
ALLOWED_UPLOAD_EXTENSIONS = ['.pdf', '.doc', '.docx', '.txt', '.png', '.jpg', '.jpeg', '.gif']
